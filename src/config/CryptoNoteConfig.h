...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x5b56;
...
*/
const char     GENESIS_COINBASE_TX_HEX[]                     = ""3000000021013d2e3d283b445da176450f079a3143009a9c25b5e9359d9c2d931327e1c3521e";
static_assert(sizeof(GENESIS_COINBASE_TX_HEX)/sizeof(*GENESIS_COINBASE_TX_HEX) != 1, "GENESIS_COINBASE_TX_HEX must not be empty.");

/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in TurtleCoind. It is used to know what timestamp
   to import from when the block height cannot be found in the node or the node is offline. */
const uint64_t GENESIS_BLOCK_TIMESTAMP                       = 1613233560;
...
const char     CRYPTONOTE_NAME[]                             = "Curiositycoin";
...
const int      RPC_DEFAULT_PORT                              =  8296;
...
{
    {  0xd2, 0x35, 0xc9, 0x34, 0xd1, 0x69, 0x42, 0xad, 0x8e, 0xf1, 0xf5, 0x98, 0x79, 0xab, 0xf6, 0xaa  }
};
